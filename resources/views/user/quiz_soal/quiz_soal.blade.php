    ...
    <div class="card">
        <div class="card-body p-0">
            ...
            <div class="input-list">
                @foreach($quiz->ganda->shuffle() as $pilihan)
...
<div class="form-button-group  transparent">
    ...
    <a href="{{route('user.quiz_soal',$quiz->mapel_id)}}" id="next_quiz" class="btn btn-primary d-none">
        Next
    </a>
</div>
...
<script>
    ...
    $("#submit_jawaban").on('click', async function () {
        ...
        await axios.post("{{route('user.cek_jawaban')}}",{
            id :"{{$quiz->id}}",
            jawaban : jawaban
        }).then(res=>{
