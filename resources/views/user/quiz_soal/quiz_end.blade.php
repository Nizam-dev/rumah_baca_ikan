...
<div class="listview-title mt-1">Selamat Anda Telah Menyelesaikan Quiz</div>
...
<div class="section mt-2">
    <div class="card">
        ...
        <div class="card-footer">
            <a href="{{route('user.mapel_view',$id)}}" class="btn mx-auto d-block btn-secondary">Kembali</a>
        </div>
    </div>
</div>
