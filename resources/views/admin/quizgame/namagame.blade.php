        ...
        <div class="col-md-12">
            ...
            <div class="px-3">
                <div class="card-header row" style="border: 1px solid black !important;">
                    ...
                    <div class="col-md-8">
                        <button class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#exampleModalCenter">Tambah Game</button>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Tambah Game</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{url('admin-namagame')}}" id="buatmapel" method="post">
                                        @csrf
                                        <div class="form-group form-inline">
                                            <label for="namamapel" class="col-md-3 col-form-label">Nama Game</label>
                                            <div class="col-md-9 p-0">
                                                <input type="text" class="form-control input-full w-100" name="nama_game" id="namamapel" placeholder="Enter Input">
                                            </div>
                                        </div>
                                ...
                                <div class="modal-body">
                                    <form action="" id="updatemapel" method="post">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="namamapel" class="col-md-3 col-form-label">Nama Game</label>
                                            <div class="col-md-9 p-0">
                                                <input type="text" class="form-control input-full" name="nama_game" id="editnamamapel" placeholder="Enter Input">
                                            </div>
                                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <span>Apakah Anda Mau menghapus Nama Game <span class="map"></span> ?</span>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
            ...
            <div>
                ...
                @foreach($namagame as $v)


                    <div class="mapel card-stats card-round col-sm-12 col-md-4">
                        <div class="card card-body">
                            <div class="float-right py-2 mt--2">
                                <i onclick="hapus('{{$v->id}}','{{$v->nama_game}}')" class="fa fa-trash float-right text-danger"></i>
                                <i onclick="edit('{{$v->id}}','{{$v->nama_game}}')" class="fa fa-edit float-right text-primary"></i>

                            </div>
                            <a href="{{url('namagame-quizgame',$v->id)}}"  class="row align-items-center">
                                <div class="col-icon">
                                ...
                                <div class="col col-stats ml-3 ml-sm-0">
                                    <div class="numbers">
                                        <p class="card-category">{{$v->nama_game}}</p>
                                    </div>
                                </div>
                            </a>
                        </div>
...
<script type="text/javascript">
    ...
    function edit(id, mapel) {
        ...
        $("#updatemapel").attr("action", "{{url('admin-namagame')}}" + "/" + id)
        $("#editMapel").modal("show")
    }

    function hapus(id, mapel) {
        $("#hapusmapel .map").html(mapel)
        $("#deletemapel").attr("action", "{{url('admin-namagame')}}" + "/" + id)
